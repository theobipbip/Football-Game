...
BACKGROUND_COLOR = 3   # Fond du terrain 
...
class Ball:
    ...
    # Si la vitesse devient très faible, on arrête la balle
    ...
    # Définir la zone verticale des buts (centrée verticalement)
...
class Player:
    def __init__(self, x, y, team, keys=None, is_keeper=False, controlled=False):
        ...
        # Position par défaut (pour revenir en défense)
        self.default_x = x
        self.default_y = y
